<form class="api-form" method="post" action="demo/api_03_wtz/Form_6_6_SmsConsume.php" target="_blank">
<p>
<label>商户号：</label>
...
<p>
  <label>交易金额：</label>
  <input id="txnAmt" pattern="\d{1,12}" type="text" name="txnAmt" placeholder="交易金额" value="1" title="单位为分，正数" required="required"/>
</p>
<p>
<label>&nbsp;</label>
