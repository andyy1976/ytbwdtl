...
class member_complainControl extends BaseMemberControl{
    ...
    public function complain_saveOp() {
        ...
        $input['complain_content']=strip_tags($input['complain_content']);
        $input['complain_content']=htmlspecialchars($input['complain_content']);
        $input['complain_content']=htmlentities($input['complain_content']);
