...
class searchControl extends BaseHomeControl {
    ...
    public function indexOp() {
        ...
        if (!is_null($goods_list)) {
            ...
            $condition = array();
            //兑换云豆
            $type_goods=$_GET['type_goods'];
            if($type_goods=='1'){
                $condition['gc_id'] = array('in','10424,10425');
            }elseif (isset($goods_param['class'])) {
