...
class show_groupbuyControl extends BaseHomeControl {
    ...
    public function indexOp()
    {
        ...
        Tpl::output('seo_keywords', '秒杀商品,商品特价秒杀');
        Tpl::output('seo_description', '万店通联商城秒杀专区汇集有秒杀商品”购”实惠,优质优价的商品抄底折扣价限时秒杀,品类齐全,让用户买的放心,用的安心.');
        Tpl::output('html_title', '秒杀商品-商品限时特价秒杀-万店通联');
