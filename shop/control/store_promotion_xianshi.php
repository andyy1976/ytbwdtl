...
class store_promotion_xianshiControl extends BaseSellerControl {
    ...
    public function xianshi_goods_addOp() {
        ...
        //20170727潘丙福添加开始-限时折扣云豆
        $xianshi_points = intval($_POST['xianshi_points']);
        //20170727潘丙福添加结束
        ...
        //20170727潘丙福添加开始-存储字段添加
        $param['xianshi_points'] = $xianshi_points;
        $param['goods_points']   = $goods_info['goods_points'];
        //20170727潘丙福添加结束
        ...
        QueueClient::push('updateGoodsPromotionPriceByGoodsId', $param['goods_id']);
        //20170517潘丙福添加结束
    ...
    public function xianshi_goods_price_editOp() {
        ...
        $xianshi_price = floatval($_POST['xianshi_price']);
        //20170727潘丙福添加开始--添加字段xianshi_points
        $xianshi_points = floatval($_POST['xianshi_points']);
        //20170727潘丙福添加结束
        $data = array();
        $data['result'] = true;
        ...
        //20170727潘丙福添加开始--添加更新字段xianshi_points
        $update['xianshi_points'] = $xianshi_points;
        //20170727潘丙福添加结束
        $condition = array();
        ...
        if($result) {
            ...
            //20170727潘丙福添加开始-用于前台显示的添加字段xianshi_points
            $data['xianshi_points'] = $xianshi_points;
            //20170727潘丙福添加结束
    ...
    public function xianshi_goods_deleteOp() {
        ...
        //20170728潘丙福添加开始--删除恢复原商品的云豆
        
        if (! Model()->table('goods')->update(array('goods_id' => $xianshi_goods_info['goods_id'], 'goods_points' => $xianshi_goods_info['goods_points']))) {
            $data['result'] = false;
            $data['message'] = L('恢复商品原云豆失败');
            echo json_encode($data);die;
        }
        //20170728潘丙福添加结束
