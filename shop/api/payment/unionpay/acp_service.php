...
class AcpService {
	...
	static function createAutoFormHtml($params, $reqUrl, $auto=true) {

		// $encodeType = isset ( $params ['encoding'] ) ? $params ['encoding'] : 'UTF-8';

		$html = '<form id="unionpay" name="unionpay" action="'.$reqUrl.'" method="post">';
		...
		if ($auto) {
			$html .= "<script>document.forms['unionpay'].submit();</script>";
		}
