...
// 签名证书路径
// const SDK_SIGN_CERT_PATH = 'D:/certs/sign.pfx';
// define('SDK_SIGN_CERT_PATH', dirname(__FILE__). '/sign.pfx');
define('SDK_SIGN_CERT_PATH', dirname(__FILE__). '/848116048160006.pfx');
...
// 密码加密证书（这条一般用不到的请随便配）
// const SDK_ENCRYPT_CERT_PATH = 'D:/certs/key.cer';
// define('SDK_ENCRYPT_CERT_PATH', dirname(__FILE__). '/key.cer');
define('SDK_ENCRYPT_CERT_PATH', dirname(__FILE__). '/acp_prod_verify_sign.cer');

// 验签证书路径（请配到文件夹，不要配到具体文件）
// const SDK_VERIFY_CERT_DIR = 'D:/certs/';
define('SDK_VERIFY_CERT_DIR', dirname(__FILE__). '/');
...
// 前台通知地址 (商户自行配置通知地址)
// const SDK_FRONT_NOTIFY_URL = 'http://shop/shop/api/payment/unionpay/return.php';
// define('SDK_FRONT_NOTIFY_URL', 'http://'. $_SERVER['HTTP_HOST'] . SHOP_SITE_URL . '/api/payment/unionpay/return.php');
define('SDK_FRONT_NOTIFY_URL', 'http://wandiantonglian.com/shop/api/payment/unionpay/return.php');

// 后台通知地址 (商户自行配置通知地址，需配置外网能访问的地址)
// const SDK_BACK_NOTIFY_URL = 'http://www.wandiantonglian.com/unionpay/notify.php';
define('SDK_BACK_NOTIFY_URL', 'https://'. $_SERVER['HTTP_HOST'] . '/shop/api/payment/unionpay/notify.php');
