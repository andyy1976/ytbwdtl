...
$pickupUrl='https://'.$host.SHOP_SITE_URL."/api/payment/tlzf/return_url.php";
$receiveUrl='https://'.$host.SHOP_SITE_URL."/api/payment/tlzf/notify_url.php";
