    ...
    <table class="ncc-table-style" nc_type="table_cart">
      <thead>
        <tr>
          ...
          <th class="w100"><?php echo $lang['cart_index_price'].'('.$lang['currency_zh'].')';?></th>
...
<?php } ?> /></td>
          ...
          <td>
          	<!--商品云豆-->
          	<em id="item_<?php echo $cart_info['cart_id']; ?>_points" class="goods-points"><?php echo $cart_info['goods_points']; ?></em> 
          </td>
          <?php if ($cart_info['state']) {?>
          <td class="ws0">
          <?php if (intval($cart_info['gc_id'])==10351){ ?>
            <?php }else{ ?>
          <a href="JavaScript:void(0);" onclick="decrease_quantity(<?php echo $cart_info['cart_id']; ?>);" title="<?php echo $lang['cart_index_reduse'];?>" class="add-substract-key tip">-</a><?php } ?>
            <input id="input_item_<?php echo $cart_info['cart_id']; ?>" bl_id="<?php echo $cart_info['bl_id'];?>" value="<?php echo $cart_info['goods_num']; ?>" orig="<?php echo $cart_info['goods_num']; ?>" changed="<?php echo $cart_info['goods_num']; ?>" onkeyup="change_quantity(<?php echo $cart_info['cart_id']; ?>, this);" type="text" class="text tc w20"  <?php if (intval($cart_info['gc_id'])==10351){ ?>
            readonly="readonly"
            <?php }else{ ?><?php } ?> />
            <?php if (intval($cart_info['gc_id'])==10351){ ?>
            <?php }else{ ?>
            <a href="JavaScript:void(0);" onclick="add_quantity(<?php echo $cart_info['cart_id']; ?>);" title="<?php echo $lang['cart_index_increase'];?>" class="add-substract-key tip" >+</a><?php } ?></td>
          <?php } else {?>
          <td>无效
          ...
          <td class="tl td-border-right"><?php if ($cart_info['bl_id'] == '0') {?>
            <a href="javascript:void(0)" onclick="collect_goods('<?php echo $cart_info['goods_id']; ?>');">收藏</a> | 
            <?php } ?>
