...
<div class="ncc-form-default">
  <form method="POST" id="addr_form" action="index.php">
    ...
    <dl>
      <dt><i class="required">*</i><?php echo $lang['cart_step1_input_true_name'].$lang['nc_colon'];?></dt>
      <dd>
        <input type="text" class="text w100" name="true_name" maxlength="20" id="true_name" value="<?php echo  $_GET['true_name']?>"/>
      </dd>
    </dl>
    <dl>
      <dt><i class="required">*</i><?php echo $lang['cart_step1_area'].$lang['nc_colon'];?></dt>
      <dd>
        ...
        <input type="hidden" name="city_id" id="_area_2" value="<?php echo  $_GET['city']?>" />
        <input type="hidden" name="area_id" id="_area"  value="<?php echo  $_GET['area']?>"/>
        </div>
      </dd>
    </dl>
    <dl>
      <dt><i class="required">*</i><?php echo $lang['cart_step1_whole_address'].$lang['nc_colon'];?></dt>
      <dd>
        <input type="text" class="text w500" name="address" id="address" maxlength="80" value="<?php echo  $_GET['address']?>"/>
        <p class="hint"><?php echo $lang['cart_step1_true_address'];?></p>
      </dd>
    </dl>
    <dl>
      <dt> <i class="required">*</i><?php echo $lang['cart_step1_mobile_num'].$lang['nc_colon'];?></dt>
      <dd>
        <input type="text" class="text w200" name="mob_phone" id="mob_phone" maxlength="15" value="<?php echo  $_GET['phone']?>"/>
        &nbsp;&nbsp;(或)&nbsp;<?php echo $lang['cart_step1_phone_num'].$lang['nc_colon'];?>
        <input type="text" class="text w200" id="tel_phone" name="tel_phone" maxlength="20" value="<?php echo  $_GET['phone_lo']?>"/>
        <input type="hidden" name="address_id" value="<?php echo $_GET['addr_id']?>">
      </dd>
    </dl>
<?php if($_GET['type']){ ?>
