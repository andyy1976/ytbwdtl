...
<div class="hr16"> <a id="hide_addr_lists" class="ncbtn ncbtn-grapefruit" href="javascript:void(0);"><?php echo $lang['cart_step1_addnewaddress_submit'];?></a></div>
...
$(function(){
    ...
    $('#hide_addr_lists').on('click',function(){
