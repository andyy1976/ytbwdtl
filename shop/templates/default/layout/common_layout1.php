...
<meta name="keywords" content="<?php echo $output['keywords']; ?>" />
<meta name="description" content="<?php echo $output['description']; ?>" />
...
<?php require_once template('layout/layout_top1');//用户中心的公共部分?>
