...
<div class="public-top-layout w">
  <div class="topbar wrapper">
    <div class="service fl">
      <div class="tel">服务热线:<b>400-066-1366</b></div>
    ...
    <div class="quick-menu">
       ...
       <dl class="my-mall">
        ...
        <dd>
          ...
          <?php if ($_SESSION['is_login']) {?>
          <ul>
            <h6 style="margin-left: 27px; color: black "><b>会员</b></h6>
            <li><a href="<?php echo urlMember('article', 'article', array('ac_id' => 5));?>">帮助中心</a></li>
            <li><a href="<?php echo urlMember('article', 'article', array('ac_id' => 6));?>">售后服务</a></li>
            <li><a href="<?php echo urlMember('article', 'article', array('ac_id' => 6));?>">在线客服</a></li>
            <li><a href="<?php echo urlMember('article', 'article', array('ac_id' => 6));?>">意见建议</a></li>
            <li><a href="<?php echo urlMember('article', 'article', array('ac_id' => 6));?>">电话客服</a></li>
            <li><a href="<?php echo urlMember('article', 'article', array('ac_id' => 6));?>">客服邮箱</a></li>
            <h6 style="margin-left: 27px; color: black "><b>商户</b></h6>
            <li><a href="<?php echo urlMember('article', 'article', array('ac_id' => 6));?>">合作招商</a></li>
            <li><a href="<?php echo urlMember('article', 'article', array('ac_id' => 6));?>">商学院</a></li>
            <li><a href="<?php echo urlMember('article', 'article', array('ac_id' => 6));?>">商家后台</a></li>
            <li><a href="<?php echo urlMember('article', 'article', array('ac_id' => 6));?>">商家帮助</a></li>
    ...
    <div class="quick-menu">
      ...
      <style>
      .pp{width: 70px !important;}
      .pp2{width: 100px !important;}
      .pp2 ul li{width: 100px}
      .pp2 img{margin-left: 10px}
      </style>
      <dl class="pp">
        <dt>常见问题<i></i></dt>
        <dd class="pp2">
          <ul>
            <li><a href="<?php echo urlMember('article', 'article', array('ac_id' => 5));?>">充值/提现问题</a></li>
            <li><a href="<?php echo urlMember('article', 'article', array('ac_id' => 6));?>">注册失败问题</a></li>
            <li><a href="<?php echo urlMember('article', 'article', array('ac_id' => 6));?>">个人信息不完整</a></li>
            <li><a href="<?php echo urlMember('article', 'article', array('ac_id' => 6));?>">订单无法提交</a></li>
            <li><a href="<?php echo urlMember('article', 'article', array('ac_id' => 6));?>">支付失败</a></li>
            <li><a href="<?php echo urlMember('article', 'article', array('ac_id' => 6));?>">商品维权</a></li>
          </ul>
        </dd>
      </dl>
       <dl class="pp">
        ...
        <dd class="pp2">
          <ul>
            <img src="<?php echo SHOP_TEMPLATES_URL;?>/images/1111.jpg" height="80" width="80"/>
            <li><a href="<?php echo urlMember('article', 'article', array('ac_id' => 6));?>">云托邦官方平台</a></li>
            <img src="<?php echo SHOP_TEMPLATES_URL;?>/images/2222.jpg" height="80" width="80"/>
            <li><a href="<?php echo urlMember('article', 'article', array('ac_id' => 6));?>">万店通联APP</a></li>
          </ul>
        </dd>
      </dl> 
       <dl class="pp">
        ...
        <dd class="pp2">
          <ul>
            <li><a href="<?php echo urlMember('article', 'article', array('ac_id' => 6));?>">4000661366(服务时间)</a></li>
          </ul>
        </dd>
      </dl> 
    </div>
        ...
        <dd>
          ...
          <div class="user-centent-menu">
            <ul>
              ...
              <li><a href="<?php echo MEMBER_SITE_URL;?>/index.php?act=member_points" class="arrow">我的云豆<i></i></a></li>
              <?php } ?>
            </ul>
          </div>
...
<link href="http://www.wandiantonglian.com/shop/templates/default/css/base.css" rel="stylesheet" type="text/css">
<style>
.pf_kefu{ width:150px; height:170px;background:url(/shop/templates/default/images/kf_bg.jpg)  ; position:fixed; right:6px; top:167px; z-index:9999999;}
</style>
...
<div class="pf_kefu">
  <p><a href="#" id="guanbi"></a></p>
   <!--  <dl>
      <dt>市场咨询</dt>
        <dd><span>客服 01</span><a target="blank" href="tencent://message/?uin=2267179780&Site=工具啦&Menu=yes"><img border="0" SRC=http://wpa.qq.com/pa?p=1:2267179780:1 alt="点击交谈"></a></dd>
        <dd><span>客服 02</span><a target="blank" href="tencent://message/?uin=2095986397&Site=工具啦&Menu=yes"><img border="0" SRC=http://wpa.qq.com/pa?p=1:2095986397:1 alt="点击交谈"></a></dd>
    </dl>
    <dl>
      <dt>商品咨询</dt>
        <dd><span>客服 01</span><a target="blank" href="tencent://message/?uin=927384273&Site=工具啦&Menu=yes"><img border="0" SRC=http://wpa.qq.com/pa?p=1:927384273:1 alt="点击交谈"></a></dd>
        <dd><span>客服 02</span><a target="blank" href="tencent://message/?uin=2994439793&Site=工具啦&Menu=yes"><img border="0" SRC=http://wpa.qq.com/pa?p=1:2994439793:1 alt="点击交谈"></a></dd>
    </dl>
    <dl>
      <dt>财务咨询</dt>
        <dd><span>客服 01</span><a target="blank" href="tencent://message/?uin=2890325374&Site=工具啦&Menu=yes"><img border="0" SRC=http://wpa.qq.com/pa?p=1:2890325374:1 alt="点击交谈"></a></dd>
        <dd><span>客服 02</span><a target="blank" href="tencent://message/?uin=438473541&Site=工具啦&Menu=yes"><img border="0" SRC=http://wpa.qq.com/pa?p=1:438473541:1 alt="点击交谈"></a></dd>
    </dl>
    <dl>
      <dt>技术咨询</dt>
        <dd><span>客服 01</span><a target="blank" href="tencent://message/?uin=1351207680&Site=工具啦&Menu=yes"><img border="0" SRC=http://wpa.qq.com/pa?p=1:1351207680:1 alt="点击交谈"></a></dd>
        <dd><span>客服 02</span><a target="blank" href="tencent://message/?uin=1806657279&Site=工具啦&Menu=yes"><img border="0" SRC=http://wpa.qq.com/pa?p=1:1806657279:1 alt="点击交谈"></a></dd>
    </dl> -->
</div>