    ...
    <div class="ncm-header-top">
      <div class="ncm-member-info">
        ...
        <dl>
          ...
          <dd>代理级别：<span style="color: red;  font-weight: bold;">
          <?php  
            if($output['member_info']['free']=='1'){
              echo '见习会员';
            }else{
              echo member_level_name($output['member_info']['member_level']);
            }
          ?></span></dd>
          <dd>会员 I D：
          ...
          <dd>用户财产：
            <div class="user-account">
              <ul>
                <li id="pre-deposit"><a href="<?php echo urlMember('predeposit', 'pd_log_list');?>" title="我的余额"> <span class="icon"></span> </a> </li>
                <li id="points"><a href="<?php echo urlMember('member_points', 'index');?>" title="我的云豆：<?php echo $output['member_info']['member_points'];?>分"> <span class="icon"></span></a> </li>
                <li id="envelope"><a href="<?php echo urlMember('member_voucher', 'index');?>" title="我的代金券：<?php echo $output['member_info']['voucher_count'];?>张"> <span class="icon"></span></a> </li>
                <li id="voucher"><a href="<?php echo urlMember('member_redpacket', 'index');?>" title="我的银行卡:<?php if($output['member_info']['member_bankcard']){echo '已绑定';}else{echo '未绑定';};?>"> <span class="icon"></span></a></li>
              </ul>
            </div>
          </dd>
        </dl>
        ...
        <li class="set"><a href="<?php echo urlMember('member', 'home');?>">用户设置<i></i></a>
          <div class="sub-menu">
            ...
            <dl>
             ...
             <?php if($output['member_info']['member_level'] >0){?> <dd><a href='<?php echo urlMember('predeposit', 'recharge_add');?>'>余额充值</a></dd><?php }?> 
...
$(function() {
  ...
  <div class="left-layout">
    ...
    <?php if ($_SESSION['member_level'] > 2){?>
	    <ul>     
	        <li><a href='index.php?act=member&op=myteam'>我的团队</a></li> 	                  
	    </ul>
    <?php }?>
    <!--
    <?php if ($_SESSION['member_level'] >1){?>
	    <ul>     
	        <li><a href='index.php?act=member&op=team'>端口设置</a></li> 	                  
	    </ul>
    <?php }?>  
    --> 
  </div>  
