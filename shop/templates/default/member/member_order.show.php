      ...
      <tbody>
        ...
        <tr class="bd-line">
          ...
          <td class="tl refund"><?php echo ncPriceFormat($goods['goods_price']); ?>
            <p class="green">
              <?php if (is_array($output['refund_all']) && !empty($output['refund_all']) && $output['refund_all']['admin_time'] > 0 && $goods_info['extend_refund']['refund_state'] == 3) {?>
              <?php echo $goods['goods_pay_price'];?><span>退</span>
              <?php } elseif ($goods['extend_refund']['admin_time'] > 0 && $goods_info['extend_refund']['refund_state'] == 3) { ?>
