  ...
  <div class="top-container">
    <div class="basic-info">
      <dl class="ncsc-seller-info">
        ...
        <dd class="seller-sc-bail">保证金：<strong><?php echo $output['store_info']['sc_bail'];?></strong> 元</dd>
      ...
      <div class="content">
        <ul>
          <?php
			...
			?>
          <li><a style="color:red;" target="_blank" <?php if($val['article_url']!=''){?>target="_blank"<?php }?> href="<?php if($val['article_url']!='')echo $val['article_url'];else echo urlMember('article', 'show', array('article_id'=>$val['article_id']));?>" title="<?php echo $val['article_title']; ?>">
