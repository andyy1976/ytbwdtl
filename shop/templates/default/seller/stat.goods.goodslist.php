...
<div class="alert mt10" style="clear:both;">
	<ul class="mt5">
    <li>1、商品分析功能比较消耗系统资源，请不要频繁查询</li>
    <li>2、<?php echo $lang['stat_validorder_explain'];?></li>
    <li>3、以下列表为从昨天开始最近30天有效订单中的所有商品数据</li>
    <li>4、近30天下单商品数：从昨天开始最近30天有效订单的某商品总销量</li>
    <li>5、近30天下单金额：从昨天开始最近30天有效订单的某商品总销售额</li>
    <li>6、点击每列旁边的箭头对列表进行排序，默认按照“近30天成交件数”降序排列</li>
    <li>7、点击每条记录后的“走势图”，查看最近30天下单金额、下单商品数、下单量走势</li>
  </ul>
</div>
<form method="get" action="index.php" target="_self" id="formSearch">
  <table class="search-form">
    ...
    <tr>
        ...
        <div class="fr">
          <a href="/index.php?act=statistics_goods&op=goodsall_export" id="panTest" class="ncbtn-mini" target="_blank" title="导出数据" style="height: 24px; line-height: 24px;"><i class="icon-print"></i>导出数据</a>
        </div>
    	</td>
    </tr>
  </table>
...
<table class="ncsc-default-table">
  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td><?php echo $v['ordertotalgoodsnum'];?></td>
...
$(function(){
    ...
    //20170812潘丙福添加--导出数据url地址重新编辑
    var trueUrl = window.location.href;
    trueUrl = trueUrl.replace(/op=goodslist/, 'op=goodsall_export');
