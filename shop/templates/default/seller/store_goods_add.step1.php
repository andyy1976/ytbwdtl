...
<div class="wrapper_search">
        ...
        <div class="wp_category_list">
          <div id="class_div_1" class="category_list">
            <ul>
              ...
              <li class="" nctype="selClass" data-param="{gcid:<?php echo $val['gc_id'];?>,deep:1,tid:<?php echo $val['type_id'];?>,flag:<?php echo $output['is_instance']['store_flag']; ?>}"> <a class="" href="javascript:void(0)"><i class="icon-double-angle-right"></i><?php echo $val['gc_name'];?></a></li>
              <?php }?>
              <?php }?>
            </ul>
          </div>
  ...
  <div class="wp_confirm">
    <form method="get">
      ...
      <input type="hidden" name="yt_id" id="yt_id" value="" />
