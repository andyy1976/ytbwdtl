...
<ul class="goods-list">
  ...
  <li>
    ...
    <a nctype="btn_add_xianshi_goods" data-storage="<?php echo $val['goods_storage'];?>" data-goods-id="<?php echo $val['goods_id'];?>" data-goods-name="<?php echo $val['goods_name'];?>" data-goods-img="<?php echo thumb($val, 240);?>" data-goods-price="<?php echo $val['goods_price'];?>" data-goods-points="<?php echo $val['goods_points'];?>" href="javascript:void(0);" class="ncbtn-mini">选择商品/修改折扣价</a> </li>
  <?php } ?>
</ul>
...
<div id="dialog_add_xianshi_goods" style="display:none;">
  ...
  <div class="eject_con">
    <div id="dialog_add_xianshi_goods_error" class="alert alert-error">
      ...
      <label for="dialog_xianshi_price" class="error" ><i class='icon-exclamation-sign'></i>折扣云豆不能为空。</label>
    </div>
    <div class="selected-goods-info">
      ...
      <dl class="goods-info">
        ...
        <dd>云豆数量：<strong class="red"><font id="dialog_goods_points"></font><?php echo '个'; ?></strong></dd>
    ...
    <!-- 20170727潘丙福添加显示折扣云豆字段 -->
    <dl>
      <dt>限时折扣云豆：</dt>
      <dd>
        <input id="dialog_xianshi_points" type="text" class="text w70">
        <em class="add-on">个</em>
        <p class="hint">默认显示当前商品云豆数量，活动开始时，系统将自动转换云豆为限时折扣云豆。</p>
      </dd>
    </dl>
    <div class="eject_con">
      <div class="bottom">
