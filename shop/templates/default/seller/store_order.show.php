...
<div class="ncsc-oredr-show">
  <div class="ncsc-order-info">
    <div class="ncsc-order-details">
      ...
      <div class="content">
        ...
        <dl>
          <dt>身份证号：</dt>
          <dd><?php echo $output['order_info']['buyer_cardid']; ?></dd>
        </dl>
        <dl>
  ...
  <div id="order-step" class="ncsc-order-step">
    ...
    <dl class="<?php if(intval($output['order_info']['payment_time']) && $output['order_info']['order_pay_state'] !== false) echo 'current'; ?>">
      <dt>支付订单</dt>
      <dd class="bg"> </dd>
      <dd class="date" title="<?php echo $lang['store_show_order_pay_time'];?>"><?php echo intval(date("His",$output['order_info']['payment_time'])) ? date("Y-m-d H:i:s",$output['order_info']['payment_time']) : date("Y-m-d H:i:s",$output['order_info']['payment_time']); ?></dd>
    </dl>
    <?php } ?>
  ...
  <div class="ncsc-order-contnet">
    <table class="ncsc-default-table order">
      ...
      <tbody>
        ...
        <?php } ?>
        <?php $i = 0; $panGoodsPayPoints = array();?>
        <?php foreach($output['order_info']['goods_list'] as $k => $goods) { ?>
        <?php $i++; $panGoodsPayPoints[] = $goods['goods_pay_points']?>
        <tr class="bd-line">
          <td>&nbsp;</td>
          ...
          <td><?php echo $goods['goods_points']; ?></td>  
        ...
        <tr>
          <td colspan="20"><dl class="freight">
            ...
            <dl class="sum">
              ...
              <dd><em><?php echo $output['order_info']['order_amount']; ?></em>元&nbsp;+<em><?php echo array_sum($panGoodsPayPoints); ?></em>(云豆)</dd>
            </dl>
          </td>
        </tr>
      </tfoot>
