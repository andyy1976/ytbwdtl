...
<?php if ($output['order_info']) {?>
  ...
  <form id="changeform" method="post" action="index.php?act=store_order&op=change_state&state_type=refund_shipping_fee&order_id=<?php echo $output['order_info']['order_id']; ?>">
