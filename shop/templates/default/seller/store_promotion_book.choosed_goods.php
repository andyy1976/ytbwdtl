  ...
  <form id="choosed_goods_form" action="<?php echo urlShop('store_promotion_book', 'choosed_goods');?>" method="post" >
    ...
    <div class="selected-goods-info">
      ...
      <dl class="goods-info">
        ...
        <dd>销售云豆：<strong class="red"><?php echo $output['goods_info']['goods_points'];?><?php echo '个'; ?></strong></dd>
    ...
    <dl>
      <dt>第一阶段 - 定金云豆：</dt>
      <dd>
        <input name="down_payment_points" type="text" class="text w70">
        <em class="add-on">个</em>
        <p class="hint">定云豆即预定商品第一阶段应付的云豆。</p>
      </dd>
    </dl>
    <dl>
      <dt>第二阶段 - 尾款金额：</dt>
    ...
    <dl>
      <dt>第二阶段 - 尾款云豆：</dt>
      <dd>
        <input name="final_payment_points" type="text" class="text w70">
        <em class="add-on">个</em>
        <p class="hint">尾款云豆即预定商品第二阶段应付的云豆。</p>
      </dd>
    </dl>
    ...
    $("#choosed_goods_form").validate({
        ...
        messages : {
            total_payment: {
                ...
                max : "<i class='icon-exclamation-sign'></i>合计总价不能超过商品销售价格",
                min : "<i class='icon-exclamation-sign'></i>合计总价最低为0.01元"
            },
            down_payment: {
                required : "<i class='icon-exclamation-sign'></i>定金价格不能为空，且必须小于商品价格",
                number : "<i class='icon-exclamation-sign'></i>定金价格必须为数字",
                min : "<i class='icon-exclamation-sign'></i>定金价格最低为0.01元"
            },
            down_payment_points: {
                required : "<i class='icon-exclamation-sign'></i>定金云豆不能为空，且必须为整数",
                number : "<i class='icon-exclamation-sign'></i>定金云豆必须为数字",
                min : "<i class='icon-exclamation-sign'></i>定金云豆最低为1个"
            },
            final_payment_points: {
                required : "<i class='icon-exclamation-sign'></i>定金云豆不能为空，且必须为整数",
                number : "<i class='icon-exclamation-sign'></i>定金云豆必须为数字",
                min : "<i class='icon-exclamation-sign'></i>尾款云豆最低为1个"
            },
            down_time: {
