...
<div class="alert alert-info mt10" style="clear:both;">
    ...
    <li>
        <span class="w210 fl h30" style="display:block;">
            <i title="钱包1" class="tip icon-question-sign"></i>
            钱包1：<strong><?php echo $output['seller_info']['wallet_frozen'].$lang['currency_zh'];?></strong>
        </span>
        <span class="w210 fl h30" style="display:block;">
            <i title="钱包2" class="tip icon-question-sign"></i>
            钱包2：<strong><?php echo $output['seller_info']['wallet_release'].$lang['currency_zh'];?></strong>
        </span>
        <span class="w210 fl h30" style="display:block;">
