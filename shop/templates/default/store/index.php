        ...
        <ul>
          ...
          <li>
            <dl>
              ...
              <dd class="goods-info"><span class="price"><i><?php echo $lang['currency'];?></i> <?php if (C('groupbuy_allow') && $value['goods_promotion_type'] == 1 && $value['times']-$value['end_time']>0){ echo ncPriceFormat($value['goods_promotion_price']);}elseif(C('groupbuy_allow') && $value['goods_promotion_type'] == 2 ){ echo ncPriceFormat($value['goods_promotion_price']);}else{ echo ncPriceFormat($value['goods_price']);}?> </span> <!-- <span class="goods-sold"><?php echo $lang['show_store_index_be_sold'];?><strong><?php echo $value['goods_salenum'];?></strong> <?php echo $lang['nc_jian'];?></span> --></dd>
              <?php if (C('groupbuy_allow') && $value['goods_promotion_type'] == 1 && $value['times']-$value['end_time']>0) {?>
