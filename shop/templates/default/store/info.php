...
<div class="ncs-info">
  <div class="title">
    <h4><a class="name" title="<?php echo $output['store_info']['store_name'];?>" target="_blank" href="<?php echo urlShop('show_store', 'index', array('store_id' => $output['store_info']['store_id']), $output['store_info']['store_domain']);?>" ><?php echo $output['store_info']['store_name']; ?></a><?php if ($output['store_info']['is_own_shop'] && $output['store_info']['store_name'] != '创意优品专营店' && $output['store_info']['store_name'] != '中华粮仓') { ?><em>自营</em><?php } ?></h4>
  </div>
  <div class="content">
<div class="store-logo"><a title="<?php echo $output['store_info']['store_name'];?>" target="_blank" href="<?php echo urlShop('show_store', 'index', array('store_id' => $output['store_info']['store_id']), $output['store_info']['store_domain']);?>" ><img src="<?php echo getStoreLogo($output['store_info']['store_label'],'store_logo');?>" alt="<?php echo $output['store_info']['store_name'];?>"></a></div>
   ...
   <?php if(!empty($output['store_info']['store_qq'])){?>
        ...
        <a target="_blank" href="https://amos.alicdn.com/getcid.aw?v=3&groupid=0&s=1&charset=utf-8&uid=<?php echo $output['store_info']['store_ww'];?>&site=cntaobao"><img border="0" src="http://amos.im.alisoft.com/online.aw?v=2&uid=<?php echo $output['store_info']['store_ww'];?>&site=cntaobao&s=2&charset=<?php echo CHARSET;?>" alt="<?php echo $lang['nc_message_me'];?>" style=" vertical-align: text-bottom;"/> 旺旺</a>
        <?php }?>
     </div>
  </div>
</div>
        ...
        <div class="content">
          <ul>
            ...
            <li>
              ...
              <!-- 修改 goods_commemr_price-->
              <div class="goods-price">￥<?php echo ncPriceFormat($g['goods_price']); ?></div>
            </li>
            <?php } ?>
          </ul>
        </div>
