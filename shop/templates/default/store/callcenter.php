...
<div class="ncs-message-bar">
  <div class="default">
    ...
    <a target="_blank" href="https://amos.alicdn.com/getcid.aw?v=3&groupid=0&s=1&charset=utf-8&uid=<?php echo $output['store_info']['store_ww'];?>&site=cntaobao" ><img border="0" src="http://amos.im.alisoft.com/online.aw?v=2&uid=<?php echo $output['store_info']['store_ww'];?>&site=cntaobao&s=2&charset=<?php echo CHARSET;?>" alt="<?php echo $lang['nc_message_me'];?>" style=" vertical-align: middle;"/></a>
    <?php }?>
  </div>
