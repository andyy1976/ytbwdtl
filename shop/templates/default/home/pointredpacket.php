      ...
      <dl class="searchbox">
        ...
        <dd>
          <ul>
            ...
            <li class="selected" nc_type="search_orderby" data-param='{"orderval":"pointsasc"}'>云豆值<em class="desc"></em></li>
            <?php } elseif ($_GET['orderby'] == 'pointsasc') {//升序选中 ?>
            <li class="selected" nc_type="search_orderby" data-param='{"orderval":"pointsdesc"}'>云豆值<em class="asc"></em></li>
            <?php } else {//未选中?>
            <li nc_type="search_orderby" data-param='{"orderval":"pointsdesc"}'>云豆值<em class="desc"></em></li>
            <?php } ?>
            <!-- 云豆值e -->
            <li>&nbsp;</li>
            <li>&nbsp;</li>
    ...
    <ul class="ncp-voucher-list">
      ...
      <li>
        <div class="ncp-voucher">
          ...
          <div class="point">
            <p class="required">需<em><?php echo $v['rpacket_t_points'];?></em>云豆</p>
