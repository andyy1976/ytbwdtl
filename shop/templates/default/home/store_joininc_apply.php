      ...
      <dl show_id="0">
        ...
        <dd>
          ...
          <?php if($output['flag']==1){ ?>
           <a href="index.php?act=store_joininc&op=stepdmstep1"><li class="<?php echo $output['sub_step'] == 'step1' ? 'current' : '';?>"><i></i>店铺资质信息</li></a>
          <a href="index.php?act=store_joininc&op=stepdmstep2">  <li class="<?php echo $output['sub_step'] == 'step2' ? 'current' : '';?>"><i></i>财务资质信息</li></a>
           <a href="index.php?act=store_joininc&op=stepdmstep3"> <li class="<?php echo $output['sub_step'] == 'step3' ? 'current' : '';?>"><i></i>店铺经营信息</li></a>
          <?php }else{ ?>
