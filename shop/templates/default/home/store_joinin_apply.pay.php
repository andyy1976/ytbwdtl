...
<link rel="stylesheet" type="text/css" href="<?php echo RESOURCE_SITE_URL;?>/js/jquery-ui/themes/ui-lightness/jquery.ui.css"  />
  ...
  <div class="joinin-pay">
    ...
    <form id="form_paying_money_certificate" action="index.php?act=store_joinin&op=panbingfu" method="post" enctype="multipart/form-data">
...
<!--       <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
    ...
    <div class="bottom"><a id="btn_paying_money_certificate" href="javascript:;" class="btn">去支付</a></div>
  </div>
