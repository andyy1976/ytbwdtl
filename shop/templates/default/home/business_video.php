  ...
  <div class="busi_1200">
    ...
    <div class="busi_infor">
        ...
        <div class="news_infor">
            <div class="video mt">
              <div id="youkuplayer<?php echo $output['data']['article_id']?>" style="width:960px;height:540px;text-align:center;margin:0 auto;"></div>
              <script type="text/javascript" src="//player.youku.com/jsapi"></script>
              <script type="text/javascript">
                  var article_url = '<?php echo $output['data']['article_url']?>';
                  player = new YKU.Player("youkuplayer"+<?php echo $output['data']['article_id']?>,{
                      styleid: '0',
