...
<div class="banner">
  <div class="user-box">
    ...
    <div class="user-joinin">
      ...
      <div class="bottom" ><?php if($_SESSION['member_name']=='13533317999'||$_SESSION['member_name']=='15813355290'){?><a href="<?php echo urlShop('store_joinin', 'stepdm');?>" target="_blank" >地面商家</a><?php } ?><a href="<?php echo urlShop('store_joinin', 'step0');?>" target="_blank">我要入驻</a><a href="<?php echo urlShop('store_joinin', 'index');?>" target="_blank">查看入驻进度</a></div>
    </div>
     <?php }else { ?>
