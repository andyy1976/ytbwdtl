    ...
    <table border="0" cellpadding="0" cellspacing="0" class="all">
      ...
      <tbody>
        ...
        <tr style='display:none'>
          <th><i>*</i>是否是地面商家</th>
          <td ><input type="radio" name="store_flag" value="0" <?php if($_GET['flag']==1){ echo " readonly=readonly"; } else{ echo "checked='checked'"; } ?>  />否 <input type="radio" name="store_flag" value="2"  <?php if($_GET['flag']==1){ echo "checked='checked'"; } else{ echo " readonly=readonly"; } ?> />是</td>
        </tr>
        <tr>
          <th><i>*</i>员工总数：</th>
