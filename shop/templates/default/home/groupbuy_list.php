...
<?php } ?>
  ...
  <div class="ncg-content">
    <div class="ncg-nav">
      <ul>
        <li<?php if ($output['current'] == 'online') echo ' class="current"'; ?>>
          <a href="<?php echo urlShop('show_groupbuy', 'groupbuy_list');?>">
               <?php if(date("H",time())>=10 &&date("H",time())<12) { ?>
                10:00
              <?php }elseif(date("H",time())>=12 &&date("H",time())<14){?>
                12:00
              <?php }elseif(date("H",time())>=14 &&date("H",time())<16){?>
                14:00
              <?php }elseif(date("H",time())>=16 &&date("H",time())<18){?>
                16:00
              <?php }elseif(date("H",time())>=18 &&date("H",time())<20){?>
              18:00
              <?php }else{?>
                10:00
              <?php } ?>
        ...
        <li<?php if ($output['current'] == 'soon') echo ' class="current"'; ?>>
          <a href="<?php echo urlShop('show_groupbuy', 'groupbuy_soon');?>">
             <?php if(date("H",time())>=10 &&date("H",time())<12) { ?>
                12:00
              <?php }elseif(date("H",time())>=12 &&date("H",time())<14){?>
                14:00
