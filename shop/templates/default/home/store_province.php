...
<?php foreach($output['store_list'] as $skey => $store){?>
    <li class="item">
      <dl class="shop-info">
        <dt class="shop-name"><a href="<?php echo urlShop('show_store','', array('store_id'=>$store['store_id']),$store['store_domain']);?>" target="_blank"><?php echo $store['store_company_name'];?></a> <img src="<?php echo SHOP_TEMPLATES_URL;?><?php echo '/images/store_grade/'.$store['grade_id'].'.png'; ?>" class="pngFix"></dt>
