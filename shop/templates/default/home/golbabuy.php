...
<div class="nch-container wrapper">
  <div class="ncp-category">
    <ul>
      ...
      <li><a class="<?php echo intval($_GET['gc_id']) <= 0?'selected':'';?>" href="<?php echo urlShop('golbabuy','index');?>">所有分类</a></li>
      <?php foreach ($output['goods_class'] as $k=>$v){?>
      <li><a class="<?php echo intval($_GET['gc_id']) == $v['gc_id']?'selected':'';?>" href="<?php echo urlShop('golbabuy','index',array('gc_id'=>$v['gc_id']));?>"}'><?php echo $v['gc_name'];?></a></li>
      <?php } ?>
    </ul>
  </div>
  <div id="promotionGoods">
    <?php require(BASE_TPL_PATH.'/home/golbabuy.item.php');?>
  </div>
  <div class="tc mt20 mb20">
    <div class="pagination" id="page-nav"></div>
  </div>
</div>
<div id="page-more"><a href="index.php?act=golbabuy&gc_id=<?php echo $_GET['gc_id'];?>&curpage=2"></a></div>
