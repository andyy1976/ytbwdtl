	...
	$.addFlex = function(t,p)
	{
		...
		var g = {
           ...
           //获取地址后的参数
            ...
            var index1=str.split("&op=")[1];
			if(index1=='account_info'){
	            //总金额
	            $('.pPagecount',this.pDiv).html('总金额'+p.count+'（元）');
	        }
	        if(index1=='account_infoll'){
	        	//总云豆
	        	 $('.pPagecount',this.pDiv).html('总云豆'+p.count+'（云豆）');
	        }
	        if(index1=='account_in'){
	        	//总云豆
	        	 $('.pPagecount',this.pDiv).html('充值转云豆'+p.count+'（云豆）');
	        }
