...
<script id="item_image_template" type="text/html">
    <div nctype="item_image" class="item">
        ...
        <input type="text" nctype="image_power" class="pan_mbsort txt w30 sort" name="item_data[item][<%=image_name%>][power]" value="<%=image_power%>">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#btn_save_item').on('click', function() {
            ...
            if(type == 'edit') {
                edit_item_image_save(num);
            } else {
                if($dialog_item_image_name.val() == '') {
                    showError('请上传图片');
                    return false;
                }
                add_item_image_save(num);
            }
            $('#dialog_item_edit_image').hide();
        });

        function edit_item_image_save(power) {
            ...
            $current_image_power.val(power);
        }

        function add_item_image_save(power) {
