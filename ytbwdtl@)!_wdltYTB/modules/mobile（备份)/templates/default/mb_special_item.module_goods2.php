...
<div class="explanation" id="explanation">
  ...
  <ul>
    <li>关于APP端商品排序（填写正整数），排序数值越大排序越靠前</li>
...
<div class="index_block goods-list">
  ...
  <div nctype="item_content" class="content">
    ...
    <div nctype="item_image" class="item">
      ...
      <input type="text" nctype="goods_power" class="pan_mbsort txt w30" name="item_data[goodspower][]" value="<?php echo $item_value['goods_power'];?>">
...
<script id="item_goods_template" type="text/html">
    <div nctype="item_image" class="item">
        ...
        <input type="text" nctype="goods_power" class="pan_mbsort txt w30" name="item_data[goodspower][]" value="1">
