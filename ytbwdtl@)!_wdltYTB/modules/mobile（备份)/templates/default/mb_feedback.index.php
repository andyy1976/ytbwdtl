...
$(function(){
    $("#flexigrid").flexigrid({
        ...
        colModel : [
			...
			{display: '回复人名字', name : 'admin_name', width : 60, sortable : true, align: 'left'},
			{display: '回复人地址', name : 'admin_ip', width : 120, sortable : true, align: 'left'},
			{display: '回复时间', name : 'fftime', width : 150, sortable : true, align: 'left'},
			{display: '回复内容', name : 'backcontent', width : 300, sortable : true, align: 'left'},
...
function fg_verify(ids) {
    _uri = "index.php?act=mb_feedback&op=goods_verify&id=" + ids;
    CUR_DIALOG = ajax_form('goods_verify', '回复留言', _uri, 640);
}
</script> 
