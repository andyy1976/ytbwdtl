...
class stat_storeControl extends SystemControl{
    ...
    public function storesales_listOp(){
        ...
        //列表字段
        $field = " store_id,min(store_name) as store_name,SUM(order_amount) as orderamount, SUM(order_pointsamount) as pointsamount, COUNT(*) as ordernum, COUNT(DISTINCT buyer_id) as membernum";
        ...
        $statheader[] = array('text'=>'下单云豆','key'=>'pointsamount','isorder'=>1);
    ...
    public function get_storesales_xmlOp(){
        ...
        $field = " store_id,min(store_name) as store_name,SUM(order_amount) as orderamount, SUM(order_pointsamount) as pointsamount, COUNT(*) as ordernum, COUNT(DISTINCT buyer_id) as membernum";
        //排序
        $order_type = array('store_name','membernum','ordernum','orderamount','pointsamount');
