...
class sm_orderControl extends SystemControl{
    /**
     * 每次导出订单数量
     * @var int
     */
   ...
   public function get_xmlOp(){
        ...
        foreach ($order_list as $order_id => $order_info) {
            ...
            $list['operation'] = "<a class=\"btn green\" href=\"index.php?act=sm_order&op=show_order&order_id={$order_info['order_id']}\"><i class=\"fa fa-list-alt\"></i>查看</a>";
            ...
            if ($order_info['if_system_receive_pay']) {
                ...
                $operation_detail .= "<li><a href=\"index.php?act=sm_order&op=change_state&state_type=receive_pay&order_id={$order_info['order_id']}\">{$op_name}</a></li>";
            }
			if($order_info['order_state']=='20'&&$order_info['is_dm']==1){
				
				 $operation_detail .= "<li><a href=\"index.php?act=sm_order&op=change_state&state_type=pay_ok&order_id={$order_info['order_id']}\">帮助买家确认订单</a></li>";
				}
            if ($operation_detail) {
            ...
            if( $order_info['order_state'] == '20'){
                 $list['operation'] .= "<a class=\"btn green\"  href=\"index.php?act=sm_order&op=change_state&state_type=pay_ok&order_id={$order_info['order_id']}\" ><i class=\"fa fa-list-alt\"></i>帮助买家</a>";
            }
    ...
    public function export_step1Op(){
        ...
        if (!is_numeric($_GET['curpage'])){
            ...
            if ($count > self::EXPORT_SIZE ){   //显示下载链接
                ...
                Tpl::output('murl','index.php?act=sm_order&op=index');
                Tpl::setDirquna('shop');
