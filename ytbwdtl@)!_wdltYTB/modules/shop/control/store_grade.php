    ...
    public function store_grade_addOp(){
        ...
        if (chksubmit()){
            ...
            if ($error != ''){
                ...
                $insert_array = array();
                $insert_array['sg_flag'] = trim($_POST['sg_flag']);
                ...
                if(intval($_POST['sg_flag'])==1){
                   $insert_array['sg_price'] = 0; 
                }else{
    ...
    public function store_grade_editOp(){
        ...
        if (chksubmit()){
            ...
            if ($error != ''){
                ...
                $update_array['sg_flag'] = trim($_POST['sg_flag']);
                ...
                if(intval($_POST['sg_flag'])){
                 $update_array['sg_price'] =0;
                }else{
