...
class provinceControl extends SystemControl{
    const EXPORT_SIZE = 1000;

    private $_links = array(
        array('url'=>'act=province&op=store','text'=>'管理'),
        array('url'=>'act=province&op=store_joinin','text'=>'开店申请'),
        ...
        // array('url'=>'act=province&op=search_order','text'=>'开店缴费记录查询')
    );
    ...
    public function get_joinin_xmlOp() {
        ...
        //店铺列表
        $condition['is_province'] = 1;
        $condition['joinin_state'] = array('lt',40);
