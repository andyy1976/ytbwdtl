  ...
  <form id="grade_form" method="post">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
       ...
       <dl class="row">
        <dt class="tit">
          <label for="sg_price"><em>*</em><?php echo '是否是线下等级：';?></label>
        </dt>
        <dd class="opt" style="width:500px" >
          <input type="radio" value="1"  name="sg_flag" class="input-txt"  <?php if($output['grade_array']['sg_flag']==1){echo "checked='checked'";}?>>是
          <input type="radio" value="0"  name="sg_flag" class="input-txt" <?php if(empty($output['grade_array']['sg_flag'])){echo "checked='checked'";}?> >否  (默认为否);
