...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?act=offlinegoods_class&op=goods_class" title="返回商品分类列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
  ...
  <form id="goods_class_form" enctype="multipart/form-data" method="post">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input id="commis_rate" class="w60" type="text" value="0" name="commis_rate" readonly="readonly">
          %<span class="err"></span>
          <p class="notic">线下商品分类分佣比例为0，且不能调整！</p>
        </dd>
      </dl>
      <dl class="row">
        <dt class="tit">
	...
	$('#goods_class_form').validate({
        ...
        rules : {
            gc_name : {
                required : true,
                remote   : {                
                url :'index.php?act=offlinegoods_class&op=ajax&branch=check_class_name',
                type:'get',
                data:{
                    gc_name : function(){
                        return $('#gc_name').val();
