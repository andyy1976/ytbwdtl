  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        ...
        <li><a href="index.php?act=predeposit&op=error_list">异常数据查询</a></li>
...
<button id='chief' style="background-color:#16A086; height: 35px; width:150px; display: block; margin: 10px auto;color: #FFF;">一键给推荐人提成</button> 
...
$(function(){
    ...
    $("#flexigrid").flexigrid({
        ...
        colModel : [
            ...
            {display: '添加时间', name : 'pdr_add_time', width : 150, sortable : true, align: 'center'},
            ...
            {display: '支付类型', name : 'pdr_type', width : 80, sortable : true, align: 'center'}
            ],
        buttons : [
