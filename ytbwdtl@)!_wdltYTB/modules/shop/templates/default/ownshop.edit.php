  ...
  <form id="store_form" method="post">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
       ...
       <dl class="row">
        <dt class="tit">
          <label for="bind_all_gc">是否设为线下商家</label>
        </dt>
        <dd class="opt">
        
            <input id="store_flag" name="store_flag" <?php if($output['store_array']['store_flag'] == '1'){ ?>checked="checked"<?php } ?> value="1" type="radio">是
            <input id="store_flag" name="store_flag" <?php if($output['store_array']['store_flag'] == '0'){ ?>checked="checked"<?php } ?> value="0" type="radio">否
