...
<div class="page">
  ...
  <div class="explanation" id="explanation">
    ...
    <ul>
      ...
      <li>列表展示了会员在搜索时间段内的有效订单总金额、预存款和云豆增减情况，并可以点击列表上方的“导出数据”将列表数据导出为Excel文件</li>
...
function update_flex(){
    $("#flexigrid").flexigrid({
        ...
        colModel : [
            ...
            {display: '消费云豆', name : 'pointsamount',  width : 120, sortable : true, align: 'center'},
            ...
            {display: '增云豆', name : 'pointsincrease',  width : 120, sortable : true, align: 'center'},
            {display: '减云豆', name : 'pointsreduce',  width: 120, sortable : true, align : 'center'}
            ],
        buttons : [
