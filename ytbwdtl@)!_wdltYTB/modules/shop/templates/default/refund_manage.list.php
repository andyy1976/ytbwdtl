...
$(function(){
    ...
    $('#ncsubmit').click(function(){
		...
		<?php if($output['flag']){ ?>
		{url: 'index.php?act=refunddm&op=get_manage_xml&'+$("#formSearch").serialize(),query:'',qtype:''}).flexReload();}
		<?php } else { ?>
        {url: 'index.php?act=refund&op=get_manage_xml&'+$("#formSearch").serialize(),query:'',qtype:''}).flexReload();}
		<?php } ?>
    ...
    $("#flexigrid").flexigrid({
		<?php if($output['flag']){ ?>
		 url: 'index.php?act=refunddm&op=get_manage_xml',
		<?php } else { ?>
