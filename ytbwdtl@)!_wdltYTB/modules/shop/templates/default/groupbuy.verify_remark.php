...
<form method="post" name="form1" id="form1" class="ncap-form-dialog" action="<?php echo urlAdminShop('groupbuy', 'goods_verify');?>">
  <input type="hidden" name="form_submit" value="ok" />
  <input type="hidden" value="<?php echo $output['common_info']['groupbuy_id'];?>" name="groupbuy_id">
  <div class="ncap-form-default">
    <dl class="row">
      <dt class="tit">审核秒杀活动ID</dt><dd class="opt"><?php echo $output['common_info']['groupbuy_id'];?></dd></dl>
      <dl class="row">
      <dt class="tit">审核秒杀活动名称</dt><dd class="opt"><?php echo $output['common_info']['groupbuy_name'];?></dd></dl>
<!--     <dl class="row">
      <dt class="tit">
        <label>审核通过</label>
      </dt>
