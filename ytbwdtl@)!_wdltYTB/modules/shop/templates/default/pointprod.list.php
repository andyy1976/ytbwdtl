...
$(function(){
    ...
    $("#flexigrid").flexigrid({
        ...
        colModel: [
            ...
            {display: '排序', name: 'pgoods_sort', width: 50, sortable: false, align: 'center'},
            ...
            {display: '兑换云豆', name: 'pgoods_points', width: 80, sortable: 1, align: 'left'},
...
//20170831潘丙福添加修改排序问题
$('input[name="panpgoods_sort"]').live('blur', function() {
  $.get('<?php echo urlAdminShop('pointprod', 'ajax_updatesort'); ?>', {
      value: $(this).val(),
      id: $(this).parents('tr').attr('data-id')
  }, function(d) {
      if (d != 'true') {
