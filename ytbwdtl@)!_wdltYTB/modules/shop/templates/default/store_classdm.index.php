    ...
    <table class="flex-table">
      <thead>
        <tr>
          ...
          <th width="149" align="left"><?php echo $lang['store_class_name'];?></th>
      ...
      <tbody>
        ...
        <tr class="edit">
          ...
          <td class="handle">
          <a class="btn red" href="javascript:if(confirm('<?php echo $lang['del_store_class'];?>'))window.location = 'index.php?act=store_classdm&op=store_class_del&sc_id=<?php echo $v['sc_id'];?>';"><i class="fa fa-trash-o"></i><?php echo $lang['nc_del'];?></a>
          <a class="btn blue" href="index.php?act=store_classdm&op=store_class_edit&sc_id=<?php echo $v['sc_id'];?>"><i class="fa fa-pencil-square-o"></i><?php echo $lang['nc_edit'];?></a>
          </td>
...
function fg_operation(name, bDiv) {
    if (name == 'add') {
        window.location.href = 'index.php?act=store_classdm&op=store_class_add';
    }
}
</script>