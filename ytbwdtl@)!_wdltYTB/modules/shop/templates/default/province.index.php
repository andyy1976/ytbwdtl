...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?act=province&op=get_xml',
        colModel : [
    ...
    $('#ncsubmit').click(function(){
        $("#flexigrid").flexOptions({url: 'index.php?act=province&op=get_xml&'+$("#formSearch").serialize(),query:'',qtype:''}).flexReload();
    });

    // 高级搜索重置
    $('#ncreset').click(function(){
        $("#flexigrid").flexOptions({url: 'index.php?act=province&op=get_xml'}).flexReload();
        $("#formSearch")[0].reset();
    });
    // //给推荐人提成
