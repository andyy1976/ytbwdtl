  ...
  <table class="flex-table">
    <thead>
      <tr>
        ...
        <th width="149" align="left">排序</th>
        <th width="149" align="left">类型</th>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="sort"><?php if($val['is_dm']==1){ echo '线下';}else{ echo '线上'; } ?></td>
      ...
      <?php }else { ?>
        <tr>
          <td class="no-data" colspan="101"><i class="fa fa-exclamation-triangle"></i><?php echo $lang['nc_no_record'];?></td>
        </tr>
      <?php } ?>
    </tbody>
  </table>
