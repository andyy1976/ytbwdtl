  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        ...
        <li><a href="index.php?act=predeposit&op=pd_cash_list_view">待审核-易宝</a></li><!-- approve -->
        <li><a href="index.php?act=predeposit&op=pd_cash_list_review">待核准-易宝</a></li><!-- Pending Review -->
      ...
      <div id="searchCon" class="content">
        <div class="layout-box">
            ...
            <dd>
              <label>
                <select name="pdc_payment_state" class="s-select">
                  ...
                  <option value="0">未支付</option><!-- 待审核 -->
                  <option value="1">已付款</option>
                  <option value="2">财务处理中</option>
                  <option value="3">其他</option>
                  <option value="4">待核准</option><!-- 已初审 -->
                  <option value="5">待打款</option><!-- 已核准 -->
          ...
          <dl>
            ...
            <dd>
              <label>
                <select name="type" class="s-select">
                  <option value=""><?php echo $lang['nc_please_choose'];?></option>
                  <option value="tlzf">通联支付</option><!-- 待审核 -->
                  <option value="ybzf">易宝支付</option>
                </select>
              </label>
            </dd>
          </dl>
...
$(function(){
    ...
    $('#export').click(function(){
        ...
        window.open("index.php?act=predeposit&op=export_cash_step1&stime="+stime
          +"&etime="+etime
          +"&predeposit_type="+predeposit_type
    ...
    $("#flexigrid").flexigrid({
        ...
        colModel : [
            ...
            {display: '提现编号', name : 'pdc_sn', width : 100, sortable : true, align: 'left'},
            {display: '会员ID', name : 'pdc_member_id', width : 50, sortable : true, align: 'center'},
            {display: '会员名称', name : 'pdc_member_name', width : 110, sortable : true, align: 'center'},
            {display: '提现金额（元）', name : 'pdc_amount', width : 80, sortable : true, align: 'left'},
            {display: '申请时间', name : 'pdc_add_time', width : 80, sortable : true, align: 'left'},
            {display: '收款银行', name : 'pdc_bank_name', width : 80, sortable : true, align: 'center'},
            {display: '收款账号', name : 'pdc_bank_no', width : 80, sortable : true, align: 'center'},
            {display: '开户姓名', name : 'pdc_bank_user', width : 80, sortable : true, align: 'center'},
            {display: '支付状态', name : 'pdc_payment_state', width : 80, sortable : true, align: 'center'},
            {display: '支付时间', name : 'pdc_payment_time', width : 130, sortable : true, align: 'center'},
            ...
            {display: '代付信息', name : 'yb_error_info', width : 60, sortable : true, align: 'center'}
        ],
        searchitems : [
