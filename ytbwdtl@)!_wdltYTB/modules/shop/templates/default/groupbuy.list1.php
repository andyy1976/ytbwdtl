        ...
        <div id="searchCon" class="content">
          <div class="layout-box">
            <dl>
              <dt>秒杀名称</dt>
              <dd>
                <input type="text" name="groupbuy_name" class="s-input-txt" placeholder="请输入秒杀名称关键字" />
              </dd>
            </dl>
            <dl>
              <dt>商品名称</dt>
...
<script>
$(function(){
    var flexUrl = 'index.php?act=groupbuy&op=groupbuy_list1_xml';
    ...
    $("#flexigrid").flexigrid({
        ...
        colModel: [
            ...
            {display: '秒杀名称', name: 'groupbuy_name', width: 400, sortable: false, align: 'left'},
            {display: '时间点', name: 'time_h', width: 80, sortable: false, align: 'center'},
            ...
            {display: '秒杀云豆', name: 'groupbuy_points', width: 60, sortable: true, align: 'center'},
            {display: '原始云豆', name: 'goods_points', width: 60, sortable: true, align: 'center'},
            {display: '当前运费', name: 'goods_freight', width: 60, sortable: true, align: 'center'},
        ...
        searchitems: [
            {display: '秒杀名称', name: 'groupbuy_name', isdefault: true},
...
// 商品审核   2017-06-23  熊磊增加
// 20171020潘丙福修改
function fg_verify(ids) {
    _uri = "index.php?act=groupbuy&op=goods_verify&id=" + ids;
    CUR_DIALOG = ajax_form('goods_verify', '拒绝活动', _uri, 640);
}
// 编辑时间段   2017-10-26  xin增加
function time_h(ids) {
    _uri = "index.php?act=groupbuy&op=time_h&id=" + ids;
    CUR_DIALOG = ajax_form('time_h', '编辑时间段', _uri, 640);
}
</script>
