  ...
  <div class="ncap-order-style">
    ...
    <div class="ncap-order-details">
      ...
      <div class="tabs-panels">
        ...
        <div class="submenu"  style="height:50px;" =""><a href="<?php echo urlAdminShop('pointprod', 'order_ship_get', array('id' => $v['point_orderid'],'type' => '2'));?> " style="height: 20px; line-height:20px; padding: 5px 10px; background:#1BBC9D; border:1px solid #16A086; float:right; color:#fff; text-decoration:none; font-size:14px; border-radius: 3px; font-weight:bold;">设置发货</a></div>
    </div>
  </div>
</div>
