  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        ...
        <li><a href="JavaScript:void(0);" class="current">代理团队人数</a></li>
      </ul>
    </div>
  </div>
  <!-- 操作说明 -->
            ...
            <dd>
              <label>
                <select name="pdr_payment_state" class="s-select">
                  ...
                  <option value="1">省代发展人数</option>
                  <option value="2">市代发展人数</option>
                  <option value="3">区县代发展人数</option>
                  <option value="4">端口发展人数</option>
                  <option value="5">会员发展人数</option>
                </select>
              </label>
            </dd>
          </dl>
...
$(function(){
    ...
    $('#ncsubmit').click(function(){
        $("#flexigrid").flexOptions({url: 'index.php?act=predeposit&op=agent_xml&'+$("#formSearch").serialize(),query:'',qtype:''}).flexReload();
    });
    // 高级搜索重置
    $('#ncreset').click(function(){
        $("#flexigrid").flexOptions({url: 'index.php?act=predeposit&op=agent_xml'}).flexReload();
        $("#formSearch")[0].reset();
    });
    ...
    $("#flexigrid").flexigrid({
        ...
        colModel : [
            {display: 'ID', name : 'pdr_id', width : 40, sortable : true, align: 'center'},
            {display: '会员ID', name : 'pdr_member_id', width : 40, sortable : true, align: 'center'},
            {display: '描述信息', name : 'pdr_member_name', width : 150, sortable : true, align: 'left'},
            {display: '发展人数（个）', name : 'pdr_amount', width : 100, sortable : true, align: 'center'},
