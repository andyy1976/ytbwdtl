...
$(function(){
    $("#flexigrid").flexigrid({
        ...
        colModel : [
            ...
            {display: '代理等级', name : 'member_level', width : 80, sortable : true, align: 'center'},
            {display: '所属省', name : 'member_provinceid', width : 80, sortable : true, align: 'center'},
            {display: '所属市', name : 'member_cityid', width : 80, sortable : true, align: 'center'},
            {display: '所属区', name : 'member_areaid', width : 80, sortable : true, align: 'center'},
            ...
            {display: '银行卡号', name : 'member_bankcard', width : 150, sortable : true, align: 'center'},
            ...
            {display: '会员云豆', name : 'member_points', width : 60, sortable : true, align: 'center'},
        ...
        searchitems : [
            ...
            {display: '银行卡号', name : 'member_bankcard'},
            ],
        sortname: "member_id",
        sortorder: "desc",
        title: '商城会员列表'
