...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?act=shop_instance&op=store_joinin" title="返回<?php echo $lang['pending'];?>列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
  ...
  <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
    ...
    <tbody>
      ...
      <?php if(empty($output['joinin_detail']['business_licence_number_elc'])){ ?>
       <tr>
        <td colspan="2">无营业执照接受网站条约
       </td>
      </tr>
      <?php }else{ ?>
      <tr>
  ...
  <form id="form_store_verify" action="index.php?act=shop_instance&op=store_joinin_verify" method="post">
    ...
    <input name="member_id" type="hidden" value="<?php echo $output['joinin_detail']['member_id'];?>" />
     <input type="hidden" name="store_flag"  value="<?php echo $output['joinin_detail']['store_flag'];  ?>"/>
    <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
      <thead>
        <tr>
