...
<form method="post" name="form1" id="form1" class="ncap-form-dialog" action="<?php echo urlAdminShop('groupbuy', 'time_h');?>">
  ...
  <div class="ncap-form-default">
    <dl class="row">
      ...
      <dt class="tit">原时间段</dt><dd class="opt"><?php echo $output['common_info']['time_h'];?>点</dd></dl>
      <dt class="tit">重新选择时间段</dt><dd class="opt">
          <select name="time_h">
