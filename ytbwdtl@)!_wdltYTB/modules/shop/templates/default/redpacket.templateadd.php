    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          ...
          <span class="err"></span>
          <p class="notic">“云豆兑换”时会员可以在云豆中心用云豆进行兑换；“卡密兑换”时会员需要在“我的商城——我的红包”中输入卡密获得红包；“免费领取”时会员可以点击红包的推广广告领取红包。</p>
        </dd>
      </dl>
      <dl class="row">
        <dt class="tit">
      ...
      <dl class="row" id="points_dl" style="display:none;">
        <dt class="tit">
          <label for="rpt_points"><em>*</em>兑换所需云豆</label>
        </dt>
        <dd class="opt">
          <input type="text" name="rpt_points" id="rpt_points" value="">
          <span class="err"></span>
          <p class="notic">兑换所需云豆应为大于1的整数</p>
        </dd>
      </dl>
      <dl class="row">
        <dt class="tit">
...
$(document).ready(function(){
	...
	$('#rpt_form').validate({
        ...
        messages : {
            ...
            rpt_points : {
            	checkpoints : '<i class="fa fa-exclamation-circle"></i>兑换所需云豆不能为空且为大于1的整数'
            },
            rpt_total  : {
