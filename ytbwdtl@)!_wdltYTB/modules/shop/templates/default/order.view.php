      ...
      <div class="tabs-panels">
        <div class="misc-info">
          ...
          <dl>
            ...
            <dd><?php echo intval(date('Y-m-d H:i:s',$output['order_info']['payment_time'])) ? date('Y-m-d H:i:s',$output['order_info']['payment_time']) : date('Y-m-d H:i:s',$output['order_info']['payment_time']);?></dd>
          </dl>
