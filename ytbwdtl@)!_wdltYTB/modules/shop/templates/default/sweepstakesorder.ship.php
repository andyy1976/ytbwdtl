...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <a class="back" href="<?php echo urlAdminShop('sweepstakes', 'pointorder_list'); ?>" title="返回列表">
        <i class="fa fa-arrow-circle-o-left"></i>
      </a>
      <div class="subject">
        <h3>云豆抽奖 - 设置发货</h3>
        <h5>设置商城会员云豆抽奖的发货信息（！！虚拟中奖礼品不需要物流单号！！）</h5>
      </div>
    </div>
  </div>

  <?php if (is_array($output['order_info']) && count($output['order_info'])>0){ ?>
  <form id="ship_form" method="post" name="ship_form" action="index.php?act=sweepstakes&op=order_ship&id=<?php echo $_GET['id']; ?>">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt"><?php echo $output['order_info']['member_id']; ?><span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <?php echo $output['order_info']['award_content']; ?>
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input type="text" id="shippingcode" name="shippingcode" class="input-txt" value="<?php echo $output['order_info']['shippingcode']; ?>">
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <select name="e_code">
              ...
              <option value="<?php echo $v['e_code'];?>" <?php echo $output['order_info']['shipping_ecode']==$v['e_code']?'selected':'';?> ><?php echo $v['e_name'];?></option>
              <?php } ?>
          </select>
          <span class="err"></span>
          <p class="notic"></p>
