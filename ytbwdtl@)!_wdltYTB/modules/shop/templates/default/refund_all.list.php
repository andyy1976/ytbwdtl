...
$(function(){
    ...
    $('#ncsubmit').click(function(){
		...
		<?php if($output['flag']){ ?>
		{url: 'index.php?act=refunddm&op=get_all_xml&'+$("#formSearch").serialize(),query:'',qtype:''}).flexReload();
		<?php }else{ ?>
			{url: 'index.php?act=refund&op=get_all_xml&'+$("#formSearch").serialize(),query:'',qtype:''}).flexReload();
		<?php  } ?>
    }
    ...
    $('#ncreset').click(function(){
		<?php if($output['flag']){ ?>
		 $("#flexigrid").flexOptions({url: 'index.php?act=refunddm&op=get_all_xml'}).flexReload();
		<?php }else{ ?>
    ...
    $("#flexigrid").flexigrid({
		<?php if($output['flag']){ ?>
		url: 'index.php?act=refunddm&op=get_all_xml',
		<?php }else{ ?>
