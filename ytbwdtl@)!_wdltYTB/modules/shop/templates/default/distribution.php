  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        ...
        <li><a href="JavaScript:void(0);" class="current">分销记录</a></li>
...
$(function(){
    ...
    $("#flexigrid").flexigrid({
        url: 'index.php?act=predeposit&op=get_dis_xml',
        colModel : [
            ...
            {display: '分销金额（元）', name : 'pdc_amount', width : 100, sortable : true, align: 'left'},
            {display: '时间', name : 'pdc_add_time', width : 100, sortable : true, align: 'left'},
            ],
        searchitems : [
