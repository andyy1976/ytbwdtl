...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3>商学院<?php echo $lang['article_index_manage'];?></h3>
...
$(function(){
    $("#flexigrid").flexigrid({
    	url: 'index.php?act=school_article&op=get_xml',
    	colModel : [
...
function fg_operate(name, bDiv) {
    if (name == 'del') {
    	...
    	window.location.href = 'index.php?act=school_article&op=article_add';
    }
}
...
function fg_delete(id) {
	...
	$.ajax({
        type: "GET",
        dataType: "json",
        url: "index.php?act=school_article&op=delete",
        data: "del_id="+id,
