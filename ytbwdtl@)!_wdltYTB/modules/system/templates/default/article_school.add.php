...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?act=article_school&op=article_class" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3>商学院<?php echo $lang['article_class_index_class'];?> - <?php echo $lang['nc_new'];?></h3>
