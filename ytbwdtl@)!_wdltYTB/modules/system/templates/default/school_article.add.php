...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?act=school_article&op=article" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3>商学院<?php echo $lang['article_index_manage'];?> - <?php echo $lang['nc_new'];?>文章</h3>
  ...
  <form id="article_form" method="post" name="articleForm">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        <dt class="tit">
          <label><em>*</em>文章描述</label>
        </dt>
        <dd class="opt">
          <input type="text" value="" name="article_blurb" id="article_blurb" class="input-txt">
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
       <dl class="row">
        <dt class="tit">
          <label><em>*</em>文章关键字</label>
        </dt>
        <dd class="opt">
          <input type="text" value="" name="article_keywords" id="article_keywords" class="input-txt">
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
...
$(document).ready(function(){
    ...
    $('#fileupload').each(function(){
        $(this).fileupload({
            dataType: 'json',
            url: 'index.php?act=school_article&op=article_pic_upload',
    ...
    $('#fileupload_img').each(function(){
        $(this).fileupload({
            dataType: 'json',
            url: 'index.php?act=school_article&op=article_img_upload',
            done: function (e,data) {
                if(data != 'error'){
