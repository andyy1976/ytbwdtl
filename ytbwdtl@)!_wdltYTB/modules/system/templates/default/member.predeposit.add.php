  ...
  <form id="points_form" method="post" name="form1">
    ...
    <div class="ncap-form-default">
      <dl class="row">
        ...
        <dd class="opt">
          <input type="text" name="member_id" id="member_id" class="input-txt" onchange="javascript:checkmember();">
          <input type="hidden" name="member_name" id="member_name" value='0'/>
          <span class="err"></span>
...
function checkmember(){
	...
	$.getJSON("index.php?act=member&op=checkmember", {'id':memberid}, function(data){
	        if (data)
	        {
		        $("#tr_memberinfo").show();
				var msg= "会员"+ data.name + "当前充值余额为" + data.member_predeposit ;
...
$(function(){
    ...
    $('#points_form').validate({
        ...
        messages : {
			...
			member_id : {
				required : '<i class="fa fa-exclamation-circle"></i>会员信息错误，请重新填写会员ID'
            },
            pointsnum  : {
