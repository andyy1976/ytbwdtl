...
<div class="page">
  ...
  <form id="user_form" enctype="multipart/form-data" method="post">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        <dt class="tit">
          <label for="member_paypwd">安全密码</label>
        </dt>
        <dd class="opt">
...
<!--       <dl class="row">
      ...
      <dl class="row">
        ...
        <dd class="opt"><strong class="red"><?php echo $output['member_array']['member_points']; ?></strong>&nbsp;云豆 </dd>
      </dl>
      <dl class="row">
        <dt class="tit">
          <label>银行卡</label>
        </dt>
        <dd class="opt"><input id="member_bankcard" class="input-txt" value="<?php echo $output['member_array']['member_bankcard']; ?>" name="member_bankcard" type="text"></dd>
      </dl>
      <dl class="row">
        <dt class="tit">
          <label>银行卡开户人</label>
        </dt>
        <dd class="opt"><input id="member_bankname" class="input-txt" value="<?php echo $output['member_array']['member_bankname']; ?>" name="member_bankname" type="text"></dd>
      </dl>
      <dl class="row">
        <dt class="tit">
          <label>经验值</label>
      ...
      <dl class="row">
        ...
        <dd class="opt"><strong class="red"><?php echo $output['member_array']['distributor_predeposit']; ?></strong>&nbsp;<?php echo $lang['currency_zh']; ?> </dd>
      </dl>
      <dl class="row">
        <dt class="tit">
          <label>充值余额</label>
        </dt>
        <dd class="opt"><strong class="red"><?php echo $output['member_array']['member_predeposit']; ?></strong>&nbsp;<?php echo $lang['currency_zh']; ?> </dd>
      </dl>
      <dl class="row">
        <dt class="tit">
