...
<ul class="cp-toast-list">
  ...
  <li>
    <span>[商城-交易]</span>
    <a target="workspace" href="<?php echo urlAdminshop('pointprod', 'pointorder_list');?>" onclick="openItem('shop|pointprod')"><i class="fa fa-bell-o"></i>有<strong><?php echo $output['statistics']['points_order'];?></strong>个云豆订单需要发货。</a>
  </li>
  <?php }?>
