...
$lang['admin_voucher_unavailable']    = '需开启 代金券、云豆，正在跳转到设置页面 。。。';
...
$lang['admin_voucher_price_points_error']   = '默认兑换云豆数应为大于0的整数';
$lang['admin_voucher_price_exist']    		= '该代金券面额已经存在';
$lang['admin_voucher_price_title']    		= '代金券面额';
$lang['admin_voucher_price_describe']    	= '描述';
$lang['admin_voucher_price_points']    		= '兑换云豆数';
$lang['admin_voucher_price_points_tip']    	= '当兑换代金券时，消耗的云豆数';
...
$lang['admin_voucher_apply_list_tip2']    	= '当商家金币不足时审核会失败，商家发布成功的代金券会出现在云豆中心，买家可凭云豆进行兑换';
 ...
 * 代金券
 */
$lang['admin_voucher_template_points_error']	= '兑换所需云豆数应为大于0的整数';
...
$lang['admin_voucher_template_points']			= '兑换所需云豆数';
