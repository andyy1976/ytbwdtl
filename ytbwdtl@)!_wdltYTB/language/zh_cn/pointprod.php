...
$lang['admin_pointprod_unavailable']	 		= '系统未开启云豆中心，是否自动开启';
...
$lang['pointprod_help1']					= '使用云豆兑换功能请先确保系统云豆状态处于开启状态（促销 -> 促销设定），礼品会出现在云豆中心，会员可凭云豆兑换，兑换成功后，由系统平台进行发货。';
$lang['admin_pointprod_goods_points']		= '兑换云豆';
...
$lang['admin_pointprod_add_goodspoint_null_error']	= '请添加兑换云豆';
$lang['admin_pointprod_add_goodspoint_number_error']	= '兑换云豆为整数且大于等于0';
