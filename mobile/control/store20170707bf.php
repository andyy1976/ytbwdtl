...
class storeControl extends mobileHomeControl
{
    ...
    public function store_infoOp()
    {
        ...
        $where['map_actives'] =array('not in','0');  //套餐设置
    ...
    public function store_goodsOp()
    {
        ...
        $condition['map_actives']=array('not in','0');  //设置套餐
    ...
    public function store_goods_rankOp()
    {
        ...
        $where = array();
        $where['store_id'] = $store_id;
        $where['map_actives']= array('not in','0');  //设置套餐
        // 默认不显示预订商品
        $where['is_book'] = 0;
        // 排序
        switch ($ordertype) {
    ...
    public function store_new_goodsOp(){
        ...
        $where['store_id'] = $store_id;
        $where['is_book'] = 0;//默认不显示预订商品
        $where ['map_actives'] = array('not in','0');
    ...
    public function store_promotionOp(){
        ...
        if (in_array('xianshi',$fields_arr)) {
            ...
            $where = array();
            $where['store_id'] = $store_id;
            $where['map_actives'] = array('not in','0,1');
            $where['state'] = 1;
