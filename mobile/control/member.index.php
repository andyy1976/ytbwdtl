  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?act=member&op=member_percentage" ><span>分成设置</span></a></li>
      </ul>
    </div>
  </div>
    ...
    <table class="table tb-type2 nobdb">
      ...
      <tbody>
        ...
        <tr class="hover member">
          ...
          <td class="align-center"><a href="index.php?act=member&op=member_edit&member_id=<?php echo $v['member_id']; ?>"><?php echo $lang['nc_edit']?></a> | <a href="index.php?act=notice&op=notice&member_name=<?php echo ltrim(base64_encode($v['member_name']),'='); ?>"><?php echo $lang['member_index_to_message'];?></a>| <a href="index.php?act=member&op=member_get&member_id=<?php echo $v['member_id']?>">充值</a>|<a href="index.php?act=member&op=member_level&member_id=<?php echo $v['member_id']?>" >会员等级</a><a href="/hualin_wandian/index.php?act=login&op=index&user_name=<?php echo $v['member_name']?>&password=<?php echo $v['member_passwd']; ?>&admin=true" target="_blank">|登陆</a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
