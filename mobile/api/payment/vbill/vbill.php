...
//  echo "<script>alert('随行付支付升级维护中，请暂时使用银联支付！！！');</script>";
//  exit;
...
$data = array(
    ...
    'pnum'          => '1',
    'pdesc'         => '1',
    'retUrl'        => 'https://ytbwdtl.com/mobile/api/payment/vbill/return_'.$type.'.php',
    'notifyUrl'     => 'https://ytbwdtl.com/mobile/api/payment/vbill/notify_'.$type.'.php',
    'bankWay'       => '',
