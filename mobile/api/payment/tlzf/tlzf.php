...
alert('APP充值正在优化中，请暂停使用！！');
// window.location.href="http://wandiantonglian.com"; 
...
$pickupUrl='https://'.$host."/mobile/api/payment/tlzf/return_url.php";
$receiveUrl='https://'.$host."/mobile/api/payment/tlzf/notify_url.php";
$fileType = mb_detect_encoding($pickupUrl, array('UTF-8','GBK','LATIN1','BIG5'));
$version="v1.0";
$language="1";
$signType="1";
$merchantId="008120189110009";
$payerName=$this->member_info['member_id'];
$payerEmail="";	
$payerTelephone="";
$payerIDCard="";
$pid="";
...
$ext1="<USER>".$member_info['uid']."</USER>";

$ext2=$type.'|'.$gc_id.'|'.$this->member_info['member_id'];
$extTL="";
$payType="33"; //payType   不能为空，必须放在表单中提交。
...
if($tradeNature != "")
 ...
 header("Content-type: text/html; charset=utf-8");
        $file  = '/data/wwwlogs/tlzf'.date('y-m-d',time()).'.log';
        $content=$bufSignSrc.'----';
...
<p style='font-size: 25px'>APP充值正在优化中，请暂停使用！！</p>
