...
class SDKConfig {
	...
	function __construct(){
		...
		$this->qrcB2cIssBackTransUrl = array_key_exists("acpsdk.qrcB2cIssBackTransUrl", $sdk_array)
			?$sdk_array["acpsdk.qrcB2cIssBackTransUrl"] : null;
		$this->qrcB2cMerBackTransUrl = array_key_exists("acpsdk.qrcB2cMerBackTransUrl", $sdk_array)
			?$sdk_array["acpsdk.qrcB2cMerBackTransUrl"] : null;
		...
		$this->ifValidateCNName = array_key_exists("acpsdk.ifValidateCNName", $sdk_array)
			?$sdk_array["acpsdk.ifValidateCNName"] : "true";
		$this->ifValidateRemoteCert = array_key_exists("acpsdk.ifValidateRemoteCert", $sdk_array)
			?$sdk_array["acpsdk.ifValidateRemoteCert"] : "false";
					
		$this->signCertPath = __DIR__ . '/848116048160005.123456.pfx';
		$this->signCertPwd = '123456';

		$this->validateCertDir = array_key_exists("acpsdk.validateCert.dir", $sdk_array)? $sdk_array["acpsdk.validateCert.dir"]: null;
		
		$this->encryptCertPath = __DIR__ . '/acp_prod_enc.cer';
		$this->rootCertPath    = __DIR__ . '/acp_prod_root.cer';
		$this->middleCertPath  =  __DIR__ . '/acp_prod_middle.cer';
		
		$this->frontUrl =  'https://' . $_SERVER['HTTP_HOST'] . '/mobile/api/payment/ylwtz/return.php';
		$this->backUrl =  'https://' . $_SERVER['HTTP_HOST'] . '/mobile/api/payment/ylwtz/notify.php';
