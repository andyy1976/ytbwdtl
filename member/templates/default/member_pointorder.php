...
<!-- point_orderallowship -->
        <?php if ($val['point_orderallowship']) { ?> 
   ...
   <?php }?>
        <!-- 处理中 -->
          <?php if ($val['point_orderallowaudit']) { ?>
          <p><a href="javascript:void(0)" class="ncbtn ncbtn-bittersweet" >不能取消订单</a></p>
          <?php } ?>
        <!-- 发货 -->
