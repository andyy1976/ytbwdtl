    ...
    <table class="ncm-search-table">
      ...
      <th></th><td></td>
        ...
        <td class="w90"><select id="paystate_search" name="paystate_search">
            ...
            <option <?php if ($_GET['paystate_search'] == '2') echo 'selected';?> value="2">财务处理中</option>
          </select>
       </td>
  ...
  <table class="ncm-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td><?php echo str_replace(array('0','1','2'),array('未支付','已支付','财务处理中'),$val['pdc_payment_state']);?></td>
