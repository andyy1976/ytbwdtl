...
<div class="wrap">
  ...
  <div class="ncm-default-form">
    ...
    <dl>
      ...
      <dd><?php 
      	if($output['info']['predeposit_type']==1){
      		echo $output['info']['pdc_amount'] / 0.87; 
      	}elseif($output['info']['predeposit_type']==2){
      		echo $output['info']['pdc_amount']; 
      	}else{
      		echo $output['info']['pdc_amount'];
      	} ?> 
    ...
    <dl>
      ...
      <dd>
      	<?php 
      	  if($output['info']['predeposit_type']==1){echo '云豆钱包提现'; }elseif($output['info']['predeposit_type']==2){echo '充值钱包提现'; }else{echo '奖金钱包提现';}
      	?>       	 	
      </dd>
    </dl>
    <dl>
