...
<!--     <dl id="email" class="<?php echo $output['member_info']['member_email_bind'] == 1 ? 'yes' : 'no';?>">
    ...
    <dl id="mobile" class="<?php echo $output['member_info']['member_mobile_bind'] == 1 ? 'yes' : 'no';?>">
      ...
      <dd><span class="explain">进行手机验证后，可用于接收敏感操作的身份验证信息，以及进行云豆消费的验证确认，非常有助于保护您的账号和账户财产安全。</span><span class="handle"><a href="index.php?act=member_security&op=auth&type=modify_mobile" class="ncbtn ncbtn-aqua bd">绑定手机</a><a href="index.php?act=member_security&op=auth&type=modify_mobile" class="ncbtn ncbtn-bittersweet jc">修改手机</a></span></dd>
    </dl>
