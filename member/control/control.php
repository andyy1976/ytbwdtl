...
class BaseMemberControl extends Control {
    ...
    public function __construct(){
        ...
        if($_SESSION['member_level'] <=1){
             $menu_list['info']['child']['member_sns'] = array();
        }
    ...
    private function _getMenuList() {
        $menu_list = array(
            'info' => array('name' => '会员资料', 'child' => array(
                ...
                'member_sns'        => array('name' => '我的团队', 'url'=>urlMember('member', 'myteam')),
                'member_teamindex'   => array('name' => '分销信息', 'url'=>urlMember('member', 'team')),
                'member_snsindex'   => array('name' => 'ID查询', 'url'=>urlMember('member', 'userid')),
				'member_snssindex'   => array('name' => '注册会员', 'url'=>urlMember('member', 'registerr')),
            ...
            'property' => array('name' => '财产中心', 'child' => array(
                ...
                'member_points'     => array('name' => '我的云豆', 'url'=>urlMember('member_points', 'index')),
                ...
                'member_redpacket'  => array('name' => '绑定农行卡', 'url'=>urlMember('member_redpacket', 'index'))
