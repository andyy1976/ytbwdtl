...
class member_evaluateLogic {
    ...
    public function save($date, $order_info, $store_info, $order_goods, $member_id, $member_name) {
        ...
        foreach ($order_goods as $value){
            ...
            $evaluate_comment=strip_tags($evaluate_comment);
            $evaluate_comment=htmlspecialchars($evaluate_comment);
            $evaluate_comment=htmlentities($evaluate_comment);
            if($_SESSION['member_id']==10088){
                echo $evaluate_comment;exit;
            }
