...
//by 33hao.com 好商城
$config = array();
$config['base_site_url'] 		= 'https://www.ytbwdtl.com/';
$config['shop_site_url']        = '/shop';
$config['cms_site_url']         = '/cms';
$config['microshop_site_url']   = '/microshop';
$config['circle_site_url']      = '/circle';
$config['admin_site_url']       = '/ytbwdtl@)!*wdltYTB';
$config['mobile_site_url']      = '/mobile';
$config['wap_site_url']         = '/wap';
$config['chat_site_url']        = '/chat';
$config['wechat_site_url']      = '/wechat/ems/';
$config['node_site_url'] 		= 'http://120.76.211.40:33'; //如果要启用IM，把  修改为您的服务器IP
// $config['delivery_site_url']    = '/delivery';
$config['chain_site_url']       = '/chain';
$config['member_site_url']      = '/member';
$config['upload_site_url']      = '/data/upload';
$config['resource_site_url']    = '/data/resource';
$config['cms_modules_url']      = '/ytbwdtl@)!*wdltYTB/modules/cms';
$config['microshop_modules_url']= '/ytbwdtl@)!*wdltYTB/modules/microshop';
$config['circle_modules_url']   = '/ytbwdtl@)!*wdltYTB/modules/circle';
$config['admin_modules_url']    = '/ytbwdtl@)!*wdltYTB/modules/shop';
$config['mobile_modules_url']   = '/ytbwdtl@)!*wdltYTB/modules/mobile';
...
$config['db']['1']['dbpwd']        = 'ytb@)!*YTBwdlt2018WDLT';
$config['db']['1']['dbname']       = 'shopnc_v5_new';
...
$config['memcache']['1']['pconnect']   = true;
$config['memcache']['1']['prefix']     = 'mc_';
