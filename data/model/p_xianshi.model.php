...
class p_xianshiModel extends Model{
    ...
    //新增开始
    public function getXianshiLists($condition, $field='*') {

        foreach ($condition as $value) {
           $xianshi_list[] = $this->table('p_xianshi_goods')->field($field)->where(array('goods_id'=>$value))->limit($limit)->page($page)->order($order)->find();
        }
