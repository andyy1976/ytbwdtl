...
<div class="home-standard-layout wrapper style-<?php echo $output['style_name'];?>">
  ...
  <ul class="right-brand">
    ...
    <ul class="tabs-nav">
      ...
      <li style="width: 68px;line-height: 42px;margin-left:20px"><?php echo $output['code_tit']['key'];?></li>
      <li style="width: 68px;line-height: 42px;margin-left:20px"><?php echo $output['code_tit']['key1'];?></li>
      <li style="width: 68px;line-height: 42px;margin-left:10px"><?php echo $output['code_tit']['key2'];?></li>
      <li style="width: 68px;line-height: 42px;margin-left:10px"><?php echo $output['code_tit']['key3'];?></li>
      <li style="width: 68px;line-height: 42px;margin-left:10px"><?php echo $output['code_tit']['key4'];?></li>
      <li style="width: 68px;line-height: 42px;margin-left:10px"><?php echo $output['code_tit']['key5'];?></li>
      <li style="width: 68px;line-height: 42px;margin-left:10px"><?php echo $output['code_tit']['key6'];?></li>
      <li style="width: 68px;line-height: 42px;margin-left:10px"><?php echo $output['code_tit']['key7'];?></li>
      <li style="width: 68px;line-height: 42px;margin-left:10px"><?php echo $output['code_tit']['key8'];?></li>
      </li>
      <?php } ?>
      <?php } ?>
    </ul>
      ...
      <ul>
        ...
        <li>
          <dl>
            ...
            <dd class="goods-price"><em><?php echo ncPriceFormatForList($v['goods_price']).'+'.$v['goods_points'].'云豆'; ?></em></dd>
          </dl>
        </li>
        <?php } ?>
      </ul>
