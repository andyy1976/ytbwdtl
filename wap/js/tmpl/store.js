    ...
    $.ajax({
        ...
        success: function(result) {
            ...
            if (data.store_info.mb_title_img) {
                $('.store-top-bg .img478').css('background-image', 'url('+data.store_info.mb_title_img+')');
            }else{//输出随机的背景图
                var topBgs = [];
                ...
                $('.store-top-bg .img478').css('background-image', 'url('+ topBgs[randomBgIndex] +')');
            }
            //店铺轮播图
            ...
            $('#store_kefu').click(function(){
			   ...
			   window.location.href='store_intro.html?store_id='+store_id;
            });
            //店主推荐
