         ...
         success:function(result){
              ...
              if (data.goods_info.is_virtual == '1') {
                  ...
                  $("#buy-now").click(function (){
                     ...
                     var key = getCookie('key');//登录标记
                      ...
                      if(data.goods_info.gc_id =='10351'){
            ...
            $('#saveform').click(function(){
              ...
              if(goods_id=='95026'){
                ...
                //     content: '111',
                // });
                // var confirm = confirm("请确认收费百分之八兑换消费云豆");
                // if(confirm == false){
                //   return false;
                // }
              }
                ...
                $('#to_card_pay').click(function(){
                    ...
                    $.get(
                        ...
                        , function(txt) {
                            ...
                            if(txt=='1'){alert('每日购买至少50金额！！！');window.location.href='https://ytbwdtl.com/wap';return false;}
                            if(txt=='2'){alert('每日限购1千金额！！！!');window.location.href='https://ytbwdtl.com/wap';return false;}
