...
$(function() { 
    ...
    function t() {
        ...
        $.ajax({
            type: "post",
            url: ApiUrl + "/index.php?act=member_sweepstakesorder&op=orderlist&page=" + page + "&curpage=" + curpage,
            data: {
                key: e,
                state_type: t,
                order_key: r
    ...
    function viewOrderDelivery() {
        ...
        location.href = WapSiteUrl + '/tmpl/member/pountorder_delivery.html?type=award&order_id=' + orderId;
    }
    ...
    function s(r) {
        $.ajax({
            type: "post",
            url: ApiUrl + "/index.php?act=member_sweepstakesorder&op=receiving_order",
            data: {
                order_id: r,
                key: e
            },
    ...
    function a(r) {
        $.ajax({
            type: "post",
            url: ApiUrl + "/index.php?act=member_sweepstakesorder&op=cancel_order",
            data: {
                order_id: r,
                key: e
            },
